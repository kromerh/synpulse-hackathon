...
def get_compliment_response():
    ...
    compliments = ["Seraina is the most beautiful woman in the world!", "Seraina has the most beautiful eyes in the world!",  "Seraina has the sexiest fooddy in the whole wide world!", "Seraina is the coolest medical doctor in the world! And she is awesome.", "Seraina is the nicest and sweetest person I know!", "Seraina is smart, funny, caring, hardworking, and super-sexy!"]
...
def get_insult_response(intent):
    """ An example of a custom intent. Same structure as welcome message, just make sure to add this intent
    in your alexa skill in order for it to work.
    """
    session_attributes = {}
    ...
    name_to_insult = intent['slots']['name']['value']
    insults = [f"{name_to_insult} is a dweeb"]
    print('Inside get_insult_response function')
    print(intent)
...
def get_bully_response(intent):
    ...
    name_to_insult = intent['slots']['nameb']['value']
...
def on_intent(intent_request, session):
    ...
    if intent_name == "compliment":
        ...
        return get_insult_response(intent)
    elif intent_name == 'bullying':
        return get_bully_response(intent)
    else:
